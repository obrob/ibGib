...
{
  /// <summary>
  /// This ViewModel represents a single Phrase in a Translation.Phrases in the use case of 'AddTranslation'.
  /// </summary>
  [Export(typeof(AddTranslationPhrasesItemViewModel))]
  [PartCreationPolicy(System.ComponentModel.Composition.CreationPolicy.NonShared)]
  //public class AddTranslationTranslationPhrasesItemViewModel : ViewModelBase<PhraseEdit, PhraseDto>
  public class AddTranslationPhrasesItemViewModel : TranslationPhrasesItemViewModelBase
  {
    public AddTranslationPhrasesItemViewModel()
      : base()
    {
      _IsChecked = false;
    }
    ...
    //public AddTranslationTranslationPhrasesItemViewModel()
    //{
